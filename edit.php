...
<body>
	...
	if(isset($_GET['nama'])){
		if($_GET['nama'] == ""){
            echo "<h4 style='color:red'> Nama Mohon Diisi !</h4>";
		}
    }
    if(isset($_GET['email'])){
		if($_GET['email'] == ""){
			echo "<h4 style='color:red'> Email Mohon Diisi !</h4>";
		}
    }
    if(isset($_GET['usrname'])){
		if($_GET['usrname'] == ""){
			echo "<h4 style='color:red'> Username Mohon Diisi !</h4>";
		}
    }
    if(isset($_GET['pwd'])){
		if($_GET['pwd'] == ""){
			echo "<h4 style='color:red'> Password Mohon Diisi !</h4>";
		}
	}
	?>
</body>
